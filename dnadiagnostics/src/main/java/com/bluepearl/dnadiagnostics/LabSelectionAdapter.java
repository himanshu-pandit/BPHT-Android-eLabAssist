...
public class LabSelectionAdapter extends BaseAdapter{
	Activity context;
	...
	public LabSelectionAdapter(Activity context, List<LabSelectionDetails> userlist) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.txtreports.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String lab_mobilenumber=userlist.get(position).getLabMobileNumber();
				String lab_Email=userlist.get(position).getLabEmailId();
				...
				editor.putString("SelectedLabMobile", lab_mobilenumber);
				editor.putString("SelectedLabEmail", lab_Email);
				editor.commit();
