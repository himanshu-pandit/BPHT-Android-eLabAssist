...
public class RegisterPatientPhlebotomyAdv extends BaseActivityPhlebotomy {
...
//		getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
		...
		else
		{
			...
			Intent i = new Intent(RegisterPatientPhlebotomyAdv.this,
					//PhlebotomyTabOn.class);
					RegisterPatientPhlebotomy.class);
	...
	public void populateTableSelectText(String tname, TableLayout myTestTable,
		...
		removebtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (RegisterPatientPhlebotomyAdv.this.selectedtestid
						.contains(idToBeRemoved)) {
					for (int k = 0; k < RegisterPatientPhlebotomyAdv.this.selectedtestid
							.size(); k++) {
						if (RegisterPatientPhlebotomyAdv.this.selectedtestid.get(k) == idToBeRemoved) {
							RegisterPatientPhlebotomyAdv.this.selectedtestid.remove(k);
						}
					}
...
//			pDialog = new ProgressDialog(RegisterPatientPhlebotomyAdv.this);
		...
		builder.setMessage(message)
				...
				.setPositiveButton("OK", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int id) {
						...
						Intent i = new Intent(RegisterPatientPhlebotomyAdv.this,PhlebotomyTabOn.class);
						//i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
						startActivity(i);
						//finish();
					}
...
/////////////////////////////////////////////////////////////////
										...
										new DialogInterface.OnClickListener() {
											...
											public void onClick(DialogInterface dialog, int which) {
												ActivityCompat.requestPermissions(
														RegisterPatientPhlebotomyAdv.this,
														PERMISSIONS,
	...
	private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener, DialogInterface.OnClickListener cancelListener) {
		new AlertDialog.Builder(RegisterPatientPhlebotomyAdv.this)
	...
	public void onBackPressed() {
		super.onBackPressed();
		Intent i = new Intent(RegisterPatientPhlebotomyAdv.this, RegisterPatientPhlebotomy.class);
		startActivity(i);
		//finish();
	}
