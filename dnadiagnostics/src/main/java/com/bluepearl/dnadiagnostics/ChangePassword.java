...
//		getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);
	...
	public void onBackPressed() 
	{
		...
		{*/
			Intent i = new Intent(ChangePassword.this,AddressSelection.class);
		/*	i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
			i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
			i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
			i.setFlags(Intent.FLAG_ACTIVITY_EXCLUDE_FROM_RECENTS);
			...
			//finish();
		/*}
		else if(user_type_frmpref.equals("Lab User"))
		{
			Intent i = new Intent(ChangePassword.this,ViewReportLabUser.class);
			i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
			startActivity(i);
			finish();
		}
		...
		{
			Intent i = new Intent(ChangePassword.this,LabSelectionForDoctor.class);
			i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
			startActivity(i);
			finish();
		}*/
