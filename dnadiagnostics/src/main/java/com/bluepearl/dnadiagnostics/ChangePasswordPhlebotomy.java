...
public class ChangePasswordPhlebotomy extends BaseActivityPhlebotomy
{
...
//		getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);
	...
	private class ChangePasswordCheck extends AsyncTask<String, Void, String> 
	{
		...
		protected void onPreExecute() 
		{
			...
			pDialog = new ProgressDialog(ChangePasswordPhlebotomy.this);
		...
		protected void onPostExecute(String result) 
		{
			...
			if (result.equals("Success")) 
			{
				...
				Intent i = new Intent(ChangePasswordPhlebotomy.this,SigninActivity.class);
			...
			else if (result.equals("Old Password Not Matched")) 
			{
				...
				Intent i = new Intent(ChangePasswordPhlebotomy.this,ChangePasswordPhlebotomy.class);
				i.putExtra("fromLogout","no");
				/*i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
	...
	public void onBackPressed() 
	{
		...
		Intent i = new Intent(ChangePasswordPhlebotomy.this,LabSelectionForDoctor.class);
		//i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		startActivity(i);
		//finish();
	}
