...
public class RegisterPatientNewAdmin extends BaseActivityAdmin {
...
System.out.println("myurl "+myurl);
		...
		btnLabchange.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(RegisterPatientNewAdmin.this, LabSelectionForDoctor.class);
	...
	public void onBackPressed() {
		super.onBackPressed();
		Intent i = new Intent(RegisterPatientNewAdmin.this, Dashboard.class);
		startActivity(i);
		//finish();
	}
	...
	void scrollDown()
	{
		Thread scrollThread = new Thread(){
			public void run(){
				try {
					sleep(200);
					RegisterPatientNewAdmin.this.runOnUiThread(new Runnable() {
						public void run() {
...
//	private TextInputLayout inputLayoutPatientName, inputLayoutAge , inputLayoutMobileNo, inputLayoutAdress ;
	...
	private void submitForm() {
		...
		Intent intent = new Intent(RegisterPatientNewAdmin.this, RegisterPatientNewAdvAdmin.class);
	...
	private class GetTestName extends
		...
		protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(RegisterPatientNewAdmin.this);
	...
	private class GetTestProfile extends
		...
		protected ArrayList<String> doInBackground(String... arg0) {
			...
			String jsonStr = sh.makeServiceCall(profilemyurl,
					ServiceHandler.GET);
			Log.d("profilemyurl770",""+profilemyurl);
			...
			if (jsonStr != null) {
				try {
					...
					Log.d("Testprofile775",""+Testprofile);
					...
					if(ServiceLenghTestProfileSize == setProfileSizee){
						...
						for (int i = 0; i < Testprofile.length(); i++) {
							...
							Log.d("strProfileData",""+strProfileData);
						...
						edt.commit();
						Log.d("profileNameSet",""+profileNameSet);
	...
	private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener,DialogInterface.OnClickListener cancelListener) {
		new AlertDialog.Builder(RegisterPatientNewAdmin.this)
				.setMessage(message)
