...
public class PatientProfile extends BaseActivity implements OnItemClickListener
{
	Button submitbtn;
	Dialog dialog;
	ListView modeList;
...
//		getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);
		...
		submitbtn.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				Log.d("button","submit button clicked!");
				// TODO Auto-generated method stub
	...
	private class ProfileCheck extends AsyncTask<String, Void, String>
	{
		...
		protected void onPostExecute(String result)
		{
			...
			if (result.equals("Profile Updated."))
			{
				...
				Intent i = new Intent(PatientProfile.this,LabSelection.class);
		...
		try
		{
			...
			if (inputStream != null)
			{
				...
				try
				{
					...
					Log.d("getUserProfile",""+patientname+dateofbirth+genderval+preferredlab_val+preferredlab_val_from_get+patientid_from_get);
	...
	//get user profile and show class
	...
	public static String profilePOST(String url)
	{
		...
		try
		{
			Log.d("profile","profile update method call");
			DefaultHttpClient httpClient = new DefaultHttpClient();
			HttpPost httpPost = new HttpPost(url);
	...
	public void onBackPressed()
	{
		...
		Intent i = new Intent(PatientProfile.this,AddressSelection.class);
	/*	i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
		i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
		i.setFlags(Intent.FLAG_ACTIVITY_EXCLUDE_FROM_RECENTS);
