...
public class AlllTestNameForAdmin extends BaseActivity {
	TabHost tabHost;
...
//		tabHost.setup(mLocalActivityManager);
		...
		{
			Intent i = new Intent(AlllTestNameForAdmin.this,RegisterPatientNewAdv.class);
			startActivity(i);
			//finish();
		}
	...
	private class GetTestCategory extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(AlllTestNameForAdmin.this);
	...
	public void onBackPressed() {
		...
		Intent i = new Intent(AlllTestNameForAdmin.this,RegisterPatientNew.class);
