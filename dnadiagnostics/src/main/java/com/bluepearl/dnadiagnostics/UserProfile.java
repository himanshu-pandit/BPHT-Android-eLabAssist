...
public class UserProfile extends BaseActivityDL implements OnItemClickListener
{
	Button submitbtn;
	Dialog dialog;
	ListView modeList;
	...
	private static final String lablist_url = "https://devglobal.elabassist.com/Services/GlobalUserService.svc/LabsInVicinityAndRecentLabs?patientid=";
	private static String lablist_myurl = "https://devglobal.elabassist.com/Services/GlobalUserService.svc/LabsInVicinityAndRecentLabs?patientid=";
	...
	private class ProfileCheck extends AsyncTask<String, Void, String>
	{
		...
		protected void onPostExecute(String result)
		{
			...
			if (result.equals("Profile Updated."))
			{
				...
				Intent i = new Intent(UserProfile.this,RegisterPatientNew.class);
		...
		try
		{
			...
			if (inputStream != null)
			{
				...
				try
				{
					...
					Log.d("profile details",patientname+dateofbirth+gender_val+preferredlab_val+preferredlab_val_from_get+patientid_from_get);
