...
public class BaseActivityPhlebotomy extends AppCompatActivity {
	Intent i1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.navigation_drawer_base_layout_labuser);
		...
		String[] array = getResources().getStringArray(R.array.order_options_menu_labuser);
	...
	protected void openActivity(int position) {
		...
		case 0:
				i1 = new Intent(BaseActivityPhlebotomy.this, LabSelectionForDoctor.class);
	...
	/*	case 1:
				i1 = new Intent(BaseActivityPhlebotomy.this, PhlebotomyTabOn.class);
				//i1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(i1);
				finish();
				break;
		*/
		...
		case 2:
			i1 = new Intent(BaseActivityPhlebotomy.this, ChangePasswordPhlebotomy.class);
			//i1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
			startActivity(i1);
			//finish();
			break;
		...
		case 4:
			...
			i1 = new Intent(BaseActivityPhlebotomy.this, SigninActivity.class);
