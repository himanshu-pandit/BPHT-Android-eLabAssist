...
public class PatientLabSelectionAdapterNew extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PatientLabSelectionAdapterNew(RecyclerView recyclerView, List<PatientLabSelectionDetailes> contacts, Activity activity) {
