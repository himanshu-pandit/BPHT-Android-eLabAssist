...
public class RegisterPatientNewAdvAdmin extends BaseActivityAdmin {
...
//		getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
	...
	Log.e("insideAdminreg","Admin registraion page");
		...
		else
		{
			...
			Intent i = new Intent(RegisterPatientNewAdvAdmin.this,RegisterPatientNewAdmin.class);
...
/////////////////////////////// test selection data ///////////////////////////////////
		...
		Log.d("profilenamefrompref474",""+profilenamefrompref);
		...
		testprofile.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				if (selectedtestpid.contains(Integer.parseInt(test_pid))) {
					...
					populateTableSelectText1(test, myTestTable, test_pid, 3,test_profileprice,test_profilediscountprice);
...
//////////////////////////////////////// popular test Method ///////////////////////////////
										...
										new DialogInterface.OnClickListener() {
											...
											public void onClick(DialogInterface dialog, int which) {
												ActivityCompat.requestPermissions(
														RegisterPatientNewAdvAdmin.this,
														PERMISSIONS,
	...
	private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener, DialogInterface.OnClickListener cancelListener) {
		new AlertDialog.Builder(RegisterPatientNewAdvAdmin.this)
	...
	public void populateTableSelectText(String tname, TableLayout myTestTable,
		...
		removebtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (RegisterPatientNewAdvAdmin.this.selectedtestid
						.contains(idToBeRemoved)) {
					for (int k = 0; k < RegisterPatientNewAdvAdmin.this.selectedtestid
							.size(); k++) {
						if (RegisterPatientNewAdvAdmin.this.selectedtestid.get(k) == idToBeRemoved) {
							RegisterPatientNewAdvAdmin.this.selectedtestid.remove(k);
						}
					}
...
////////////////////////////////  Patient Register button methods  ////////////////////////////////////////////////////////////
	...
	private class uploadAllData extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(RegisterPatientNewAdvAdmin.this);
		...
		builder.setMessage(message + "\nCall us for appointment booking..")
				...
				.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int id) {
						...
						Intent i = new Intent(RegisterPatientNewAdvAdmin.this,
								RegisterPatientNewAdmin.class);
