...
public class ViewReportAdmin extends BaseActivityAdmin {
    ...
    AutoCompleteTextView textView, textViewCCA;
...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        //ColorDrawable colorDrawable = new ColorDrawable(Color.parseColor("#E1008A"));
        //getSupportActionBar().setBackgroundDrawable(colorDrawable);
        ...
        textViewCCA.setOnItemSelectedListener(
                new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        Toast.makeText(ViewReportAdmin.this, "posi " + position + " " + id, Toast.LENGTH_SHORT).show();
    ...
    private class GetPatientCheck extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(ViewReportAdmin.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if (labuserList.size() == 0) {
                ...
                patientAdapter = new LabUserAdapter(ViewReportAdmin.this, labuserList);
            ...
            labuserlistview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                    ...
                    Intent intent = new Intent(ViewReportAdmin.this,ViewReportAttachment.class);
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        if (flg) {
            Intent i = new Intent(ViewReportAdmin.this, ViewReportAdmin.class);
            //	i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            //	i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(i);
            //finish();
        }
        Intent i = new Intent(ViewReportAdmin.this, Dashboard.class);
        //i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(i);
        //finish();
    }
    ...
    public void showAlert(String message, String title) {
        ...
        //builder.setIcon(R.drawable.signlogo);
        builder.setMessage(message)
                .setCancelable(false)
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent i = new Intent(ViewReportAdmin.this,
                                ViewReportAdmin.class);
                        //i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(i);
                        //finish();
                    }
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener, DialogInterface.OnClickListener cancelListener) {
        new AlertDialog.Builder(ViewReportAdmin.this)
                .setMessage(message)
