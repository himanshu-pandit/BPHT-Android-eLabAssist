...
public class ChangePasswordForAdmin extends BaseActivityAdmin
{
...
//		getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
	...
	public static String ChangePOST(String url)
	{
		...
		try 
		{
			...
			//nameValuePairs.add(new BasicNameValuePair("\"AppID\"", "\"e82c0f22-ccb5-4966-a1a3-53a577799f10\""));

			nameValuePairs.add(new BasicNameValuePair("\"AppID\"", "\""+ selected_labidfrompref + "\""));
	...
	private class ChangePasswordCheck extends AsyncTask<String, Void, String>
	{
		...
		protected void onPreExecute() 
		{
			...
			pDialog = new ProgressDialog(ChangePasswordForAdmin.this);
		...
		protected void onPostExecute(String result)
		{
			...
			if (result.equals("Success")) 
			{
				...
				Intent i = new Intent(ChangePasswordForAdmin.this,SigninActivity.class);
			...
			else if (result.equals("Old Password Not Matched")) 
			{
				...
				Intent i = new Intent(ChangePasswordForAdmin.this,ChangePasswordForAdmin.class);
				i.putExtra("fromLogout","no");
				/*i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
	...
	public void onBackPressed() 
	{
		...
		Intent i = new Intent(ChangePasswordForAdmin.this,Dashboard.class);
		//i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		startActivity(i);
		//finish();
	}
